...
public class FilmSql {
    ...
    public static final String UPDATE_GENRE = "INSERT INTO film_genres (film_id, genre_id) VALUES (:film_id, :genre_id)";
    ...
    public static final String INSERT_FILM_GENRE_QUERY = "INSERT INTO film_genres (film_id, genre_id) VALUES (:film_id, :genre_id)";
